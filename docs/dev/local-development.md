...
With the cluster ready, use the [Quickstart](./quickstart) for the one-click CLI flow. The local k3d quickstart installs the stack, registers the local cluster, and installs NVCA.
