...
4. Proceed with the [control-plane installation](./helmfile-installation.md)
...
For details on the bootstrap process, see [self-managed-clusters](cluster-management/self-managed.md) (Manual Cluster
Registration).
