...
func TestClientEnvSettings(t *testing.T) {
	...
	caCertBytes, err := os.ReadFile(cwd + "/test-fixtures/keys/cert.pem.fixture")
	if err != nil {
		t.Fatalf("error reading %q cert file: %v", cwd+"/test-fixtures/keys/cert.pem.fixture", err)
	}
	...
	os.Setenv(EnvVaultCACert, cwd+"/test-fixtures/keys/cert.pem.fixture")
	os.Setenv(EnvVaultCACertBytes, string(caCertBytes))
	os.Setenv(EnvVaultCAPath, cwd+"/test-fixtures/keys")
	os.Setenv(EnvVaultClientCert, cwd+"/test-fixtures/keys/cert.pem.fixture")
	os.Setenv(EnvVaultClientKey, cwd+"/test-fixtures/keys/key.pem.fixture")
