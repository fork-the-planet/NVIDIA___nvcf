...
// added for nv
// updated go-jose to v4 for cve resolution
// and v4 requires allowed signatures to be passed when parsing the unwrap token
// note: plugin_helpers.go is not used by ess-agent runtime
...
func VaultPluginTLSProviderContext(ctx context.Context, apiTLSConfig *TLSConfig) func() (*tls.Config, error) {
	...
	return func() (*tls.Config, error) {
		...
		parsedJWT, err := jwt.ParseSigned(unwrapToken, AllowedSignatureAlgorithms)
		if err != nil {
