...
type Config struct {
	...
	ESS *VaultConfig `mapstructure:"ess"`
	...
	// added for nv
	// ESSHeaders contains headers for the Vault client
	ESSHeaders map[string]string
}
