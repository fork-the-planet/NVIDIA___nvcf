...
// added for nv
func DefaultVaultRetryConfig() *RetryConfig {
	// added for nv

	// the below numbers ensure we retry exponentially and
	// don't go over max 600 seconds (~596.5 seconds)
	maxBackoff := 41 * time.Second
	attempts := 20
