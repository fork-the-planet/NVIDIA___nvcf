...
// added for nv
// Previously we were using dependency.TransportDialer for CustomDialer under TransportConfig.
// However, when we added Telemetry package, we were getting cyclic import errors.
// To break the cyclic dep, config package was made to not depend on the dependency package.
//
