...
// nv TODO refactor after validating opens source implementation of file ownership
//func TestChownFile(t *testing.T) {
//	// Init test variables
//	testFile := os.NewFile(0, "testFile")
//
//	testUserNameStr := "testUserName"
//	testUserName := &testUserNameStr
//	testUserNameStrEmpty := ""
//	testUserNameEmpty := &testUserNameStrEmpty
//
//	testGroupNameStr := "testGroupName"
//	testGroupName := &testGroupNameStr
//	testGroupNameStrEmpty := ""
//	testGroupNameEmpty := &testGroupNameStrEmpty
//
//	testUser := &user.User{
//		Uid: "1000",
//	}
...
//
//	// Replace functions
//	var lookupUserErr, lookupGroupErr, chownErr error
//	lookupUser = func(username string) (*user.User, error) {
//		return testUser, lookupUserErr
//	}
//	lookupGroup = func(name string) (*user.Group, error) {
//		return testGroup, lookupGroupErr
//	}
...
//		},
//		{
//			name:           "empty user and group",
//			file:           testFile,
//			userName:       testUserNameEmpty,
//			groupName:      testGroupNameEmpty,
//			lookupUserErr:  nil,
//			lookupGroupErr: nil,
//			chownErr:       nil,
//			throwsError:    false,
...
//		},
//		{
//			name:           "lookup user error",
//			file:           testFile,
//			userName:       testUserName,
//			groupName:      testGroupName,
//			lookupUserErr:  fmt.Errorf(""),
//			lookupGroupErr: nil,
//			chownErr:       nil,
//			throwsError:    true,
//		},
//		{
//			name:           "lookup group error",
//			file:           testFile,
//			userName:       testUserName,
//			groupName:      testGroupName,
//			lookupUserErr:  nil,
//			lookupGroupErr: fmt.Errorf(""),
//			chownErr:       nil,
//			throwsError:    true,
//		},
//		{
...
//			lookupUserErr = tc.lookupUserErr
//			lookupGroupErr = tc.lookupGroupErr
//			chownErr = tc.chownErr
//			err := chownFile(tc.file, tc.userName, tc.groupName)
//			if err == nil && tc.throwsError {
//				t.Fatal("expected an error, but err was nil")
//			}
//			if err != nil && !tc.throwsError {
//				t.Fatal(fmt.Sprintf("expected no error, but err was %v", err))
//			}
//		})
//	}
//}
