...
/*
Partially copied from https://github.com/kubernetes/kubernetes/blob/master/pkg/api/v1/resource/helpers_test.go
*/
...
func TestPodRequestsAndLimits(t *testing.T) {
	...
	for idx, tc := range cases {
		resRequests := podRequests(tc.pod)
		resLimits := podLimits(tc.pod)
