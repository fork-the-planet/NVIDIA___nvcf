...
func TestNewTokenFetcher(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			fndsServiceURL: "https://stage.stg.nvidia.com",
			envSetup:       map[string]string{},
			wantErr:        false,
		},
		{
			...
			fndsServiceURL: "https://prod.nvidia.com",
			envSetup:       map[string]string{},
			wantErr:        false,
		},
		{
			...
			fndsServiceURL: "https://stage.nvidia.com",
			envSetup: map[string]string{
				"FNDS_OAUTH_CLIENT_ID":         "env-client-id",
				"FNDS_OAUTH_CLIENT_SECRET_KEY": "env-secret-key",
			},
			wantErr: false,
		},
		{
		...
		},
		{
			...
			fndsServiceURL: "https://prod.nvidia.com",
			envSetup: map[string]string{
				"FNDS_NGC_SERVICE_API_KEY":      "env-ngc-key",
				"FNDS_NGC_SERVICE_API_KEY_FILE": "/env/ngc-key-file",
			},
			wantErr: false,
		},
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			fetcher, healthCheck, err := NewTokenFetcher(ctx, tt.opts, tt.fndsServiceURL)
			if tt.wantErr {
				assert.Error(t, err)
...
func TestGetFNDSTokenFetcherOptions(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			fndsServiceURL: "https://something.stg.something-else.nvidia.com",
			envSetup:       map[string]string{},
			want: nvcaauth.TokenFetcherOptions{
				OAuthClientID:             "test-client-id",
				OAuthClientSecretKey:      "test-secret-key",
		...
		},
		{
			...
			fndsServiceURL: "https://stg.deployment-stages.nvidia.com",
			envSetup:       map[string]string{},
			want: nvcaauth.TokenFetcherOptions{
				OAuthClientID:             "test-client-id",
				OAuthClientSecretKey:      "test-secret-key",
		...
		},
		{
			...
			fndsServiceURL: "https://stage.stg.nvidia.com",
			envSetup: map[string]string{
				"FNDS_STAGE_OAUTH_TOKEN_URL": "https://custom.stage.token.url",
				"FNDS_STAGE_OAUTH_JWKS_URL":  "https://custom.stage.jwks.url",
			},
			want: nvcaauth.TokenFetcherOptions{
				OAuthClientID:             "test-client-id",
				OAuthClientSecretKey:      "test-secret-key",
		...
		},
		{
			...
			fndsServiceURL: "https://prod.nvidia.com",
			envSetup: map[string]string{
				"FNDS_PROD_OAUTH_TOKEN_URL": "https://custom.prod.token.url",
				"FNDS_PROD_OAUTH_JWKS_URL":  "https://custom.prod.jwks.url",
			},
			want: nvcaauth.TokenFetcherOptions{
				OAuthClientID:             "test-client-id",
				OAuthClientSecretKey:      "test-secret-key",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got := getFNDSTokenFetcherOptions(tt.opts, tt.fndsServiceURL)
...
func TestGetFNDSTokenFetcherOptions_WithEnvVars(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result := getFNDSTokenFetcherOptions(tt.opts, "https://test.nvidia.com")
			...
			assert.Equal(t, "write", result.OAuthTokenScope)
