...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Custom color palette inspired by terminal/GPU aesthetics
        gpu: {
          50: '#f0fdf4',
          100: '#dcfce7',
          200: '#bbf7d0',
      ...
      keyframes: {
        ...
        glow: {
          '0%': { boxShadow: '0 0 5px rgb(34 197 94 / 0.2), 0 0 20px rgb(34 197 94 / 0.1)' },
          '100%': { boxShadow: '0 0 10px rgb(34 197 94 / 0.4), 0 0 40px rgb(34 197 94 / 0.2)' },
        },
      },
      backgroundImage: {
