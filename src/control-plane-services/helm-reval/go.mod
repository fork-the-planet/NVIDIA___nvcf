...
require (
	github.com/NVIDIA/nvcf/src/compute-plane-services/image-credential-helper v0.0.0-20260430124028-51c498df1520
	github.com/NVIDIA/nvcf/src/libraries/go/lib v0.0.0-20260422170823-102dd819d7cc
