...
type RateLimitRequest struct {
	...
	// clientAuthSubject is the unique caller identity the upstream service resolves
	// from the request's credentials (e.g. a per-user delegation token or API key). When non-empty
	// and a per-user rate is configured for the function version, an additional
...
func (x *RateLimitRequest) GetClientAuthSubject() string {
	if x != nil {
