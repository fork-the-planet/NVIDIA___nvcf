...
NVCT_BACKEND=GFN
NVCT_BACKEND_GPU_TYPE=A10G
NVCT_BACKEND_INSTANCE_TYPE=ga10g_1.br20_2xlarge

TASK_NAME=byoo-metrics-validating-test-non-gfn-$(whoami)-$(date '+%H%M%S')
TASK_WORKLOAD_TYPE="container"
TASK_CONTAINER_IMAGE="stg.nvcr.io/tadiathdfetp/task_byoo_sample:0.0.9"
